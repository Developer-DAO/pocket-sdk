...
/// Next index: 6
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct EventMorseAccountRecoveredAdmin {
...
/// Next free index: 4
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct MsgAdminRecoverMorseAccount {
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct MsgAdminRecoverMorseAccountResponse {}
/// Generated client implementations.
pub mod msg_client {
    #![allow(
        unused_variables,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn admin_recover_morse_account(
            &mut self,
            request: impl tonic::IntoRequest<super::MsgAdminRecoverMorseAccount>,
        ) -> std::result::Result<
            tonic::Response<super::MsgAdminRecoverMorseAccountResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/pocket.migration.Msg/AdminRecoverMorseAccount",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("pocket.migration.Msg", "AdminRecoverMorseAccount"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
